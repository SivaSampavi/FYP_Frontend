...
const MyBids = () => {
  const data = [
    ...
    { id: 1, biddingvalue: 'Bidding', saltvalue: '10:00 AM', minusagetime: '12:00 PM', deposit: 5, remainingtime: 2 }
  ];
          ...
          <tbody>
            {data.map((row) => (
              <tr key={row.id}>
                ...
                <td><Link to="/revealbid"><button type="submit">Reveal Bid</button></Link></td>
              </tr>
            ))}
          </tbody>
        </table>
